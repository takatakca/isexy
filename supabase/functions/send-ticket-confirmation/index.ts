      ...
      <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f8f9fa;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0;">
                    <span style="background: ${priorityColors[priority] || '#6b7280'}; color: white; padding: 4px 12px; border-radius: 20px; font-size: 12px; text-transform: uppercase;">
                      ${priority}
                    </span>
                  </td>
                </tr>
            ...
            <!-- Message Preview -->
            <div style="background: #fef3f2; border-left: 4px solid #e11d48; padding: 15px; margin: 20px 0; border-radius: 0 8px 8px 0;">
              <h4 style="color: #1f2937; margin: 0 0 10px 0; font-size: 14px;">Your Message:</h4>
              <p style="color: #4b5563; margin: 0; font-size: 14px; line-height: 1.5;">${message.substring(0, 300)}${message.length > 300 ? '...' : ''}</p>
            </div>
