...
const categoryInterests: Record<string, string[]> = {
  "long-term": ["long-term", "relationship", "marriage", "commitment"],
  serious: ["serious", "relationship", "commitment"],
  tonight: ["tonight", "casual", "spontaneous"],
  "short-term": ["casual", "fun", "short-term"],
  friends: ["friends", "friendship", "platonic"],
  "non-mono": ["non-monogamous", "polyamory", "open"],
  ...
  coffee: ["coffee", "cafe"],
  "date-night": ["date night", "dining", "romantic"],
