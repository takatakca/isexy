...
import { ArrowLeft, TicketIcon, Clock, CheckCircle, AlertCircle, TrendingUp, Users } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto p-4 space-y-6">
        ...
        <div className="flex gap-3">
          <Button onClick={() => navigate('/admin/tickets')} className="flex-1">
            <TicketIcon className="h-4 w-4 mr-2" />
            Manage Tickets
          </Button>
          <Button variant="outline" onClick={() => navigate('/admin/categories')} className="flex-1">
